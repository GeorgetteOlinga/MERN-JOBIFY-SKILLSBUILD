...
#### Install Packages and libraries (Optional)
...
#### Link Component
for example: set up two links:
                        1- register to login page
                        2-login back to register page
...
```jsx
{
    path: '/',
    element: <HomeLayout />,
    children: [   {/*  children can be shown across the pages like    */}
      {                   
        index: true,
        element: <Landing />,
      },
...
#### Styled Components
- NB: make sure vscode styled-components is installed
- CSS in JS
- Styled Components
